...
HD_PWD='C:/VIVADO-PROJECTS/13_ROBERTSON_SIM/13_ROBERTSON_SIM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log molt_rob.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source molt_rob.tcl
